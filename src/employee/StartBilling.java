...
public class StartBilling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Item.png"))); // NOI18N
        ...
        jLabel9.setText("______________________________________");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
       ...
       EmployeeProfile obj = new EmployeeProfile(null);
        obj.setVisible(true);
        setVisible(false);
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        String itemid = (String) jTextField1.getText();
        try (Connection conn = dbConnection.DbConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                jLabel9.setText(ItemDesc);
                jLabel5.setText(ItemName);
                jLabel7.setText(ItemPrice);
                jLabel12.setText(Category);
                jTextField6.setText(ItemPrice);
                ...
                jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Item.png")));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        if (!price.equals("________________________")) {
            jTextField6.setText("" + Integer.parseInt(quantity) * Integer.parseInt(price));
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String itemprice = jLabel7.getText();
        String quantity = (String) jComboBox1.getSelectedItem();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        ItemList obj = new ItemList(ed,hm);//pass to Itemlist class
        obj.setVisible(true);
        setVisible(false);
